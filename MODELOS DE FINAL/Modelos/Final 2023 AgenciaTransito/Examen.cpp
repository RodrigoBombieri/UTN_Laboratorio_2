...
/*Hacer un m�todo llamado Punto3 que solicite un ID Tipo de Infracci�n por teclado. Luego verifique
si el mismo existe en el archivo de tiposinfracciones.dat. De existir, listar la cantidad
de agentes distintos que hayan realizado al menos una multa para este tipo de infracci�n.
...
void Examen::Punto3()
{
    ...
    if (contador !=0)
    {
        cout<<"La cantidad de agentes distintos que realizaron al menos una multa para este tipo de infraccion son ";
        cout<< contador;
    }
